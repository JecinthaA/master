...
/**
 * Created by BLT0059 on 6/6/2015.
 */
public class GPSTracker extends Service implements LocationListener {
    ...
    public static String TAG = "GPSTracker";
        ...
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                if (isNetworkEnabled) {
                    ...
                    System.out.println(TAG+ ">>Network enabled");
                ...
                if (isGPSEnabled) {
                    if (location == null) {
                        ...
                        System.out.println(TAG+ ">>GPS Enabled");
    ...
    public void showSettingsAlert(){
        System.out.println("settttnhjhbnbc");
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(mContext);
        // Setting Dialog Title
        alertDialog.setTitle(mContext.getResources().getString(R.string.GPS_settings));

        // Setting Dialog Message
        alertDialog.setMessage(mContext.getResources().getString(R.string.gps_not_enabled_go2_settings));
